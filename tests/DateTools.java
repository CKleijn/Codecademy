...
public class DateTools {
     ...
     */ 
     public static boolean validateDate(int day, int month, int year)  {
        ...
        if(day >= 1 && day <= 31 && (month == 1 || month == 3 || month == 5 || month == 7 || month == 8 || month == 10 || month == 12) && currentYear >= year && year > currentYear-120) {
             return true;
        } else if(day >= 1 && day <= 30 && (month == 4 || month == 6 || month == 9 || month == 11) && currentYear >= year && year > currentYear-120) {
            return true;
        } else if(day >= 1 && day <= 29 && (month == 2 && (year % 4 == 0 && (year % 100 != 0 || year % 400 == 0))) && currentYear >= year && year > currentYear-120) {
            return true;
        } else if(day >= 1 && day <= 28 && (month == 2 && (year % 4 != 0 || (year % 100 == 0 && year % 400 != 0))) && currentYear >= year && year > currentYear-120) {
            return true;
        } else {
             return false;
        }
